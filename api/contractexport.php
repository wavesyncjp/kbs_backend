...
if($template['reportFormType'] == '01' || $template['reportFormType'] == '03') {
    if(sizeof($detailIds) > 0) {
        ...
        $locs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $detailIds)->where('locationType', '01')->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
        // 20220329 E_Update
    }
    ...
    if(sizeof($teichiIds) > 0) {
        ...
        $locs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $teichiIds)->where('locationType', '01')->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
        // 20220329 E_Update
    }
}
//土地荷主あり
...
if($template['reportFormType'] == '05') {
    if(sizeof($detailIds) > 0) {
        ...
        $locs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $detailIds)->where('locationType', '04')->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
        // 20220329 E_Update
    }
    ...
    if(sizeof($detailIds) > 0) {
        ...
        $locs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $detailIds)->where('locationType', '02')->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
        // 20220329 E_Update
    }
}
//土地荷主あり
...
if(sizeof($detailIds) > 0 && $template['reportFormType'] != '01') {
    ...
    */
    $tempLocs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $detailIds)->where('locationType', '04')->where_not_null('ridgePid')
                ->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->distinct()->findArray();
    // 20220329 E_Update
    $ids = [];
    foreach($tempLocs as $temp) {
...
//        $keyword = 'p_address';
        ...
        if(sizeof($detailIds) > 0 && $template['reportFormType'] != '01') {
            ...
            $subLocs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $detailIds)->where('locationType', '04')->where('ridgePid', $loc['pid'])->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
            // 20220329 E_Update
        }
...
if(sizeof($belongIds) > 0) {
    ...
    $locs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $belongIds)->where('locationType', '01')->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
    // 20220329 E_Update
}
...
if(sizeof($belongIds) > 0) {
    ...
    $locs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $belongIds)->where('locationType', '02')->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
    // 20220329 E_Update
}
...
if(sizeof($belongIds) > 0) {
    ...
    */
    $tempLocs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $belongIds)->where('locationType', '04')->where_not_null('ridgePid')->where_null('deleteDate')
                ->order_by_asc('displayOrder')->order_by_asc('pid')
                ->distinct()->findArray();
    // 20220329 E_Update
    $ids = [];
    foreach($tempLocs as $temp) {
...
//        $subBlockCount = 7;
        ...
        if(sizeof($belongIds) > 0) {
            ...
            */
            $subLocs = ORM::for_table(TBLLOCATIONINFO)->where_in('pid', $belongIds)
                    ->where('locationType', '04')->where('ridgePid', $loc['pid'])
                    ->where_null('deleteDate')->order_by_asc('displayOrder')->order_by_asc('pid')->findArray();
            // 20220329 E_Update
        }
        if(sizeof($subLocs) > 0) {
            //ブロックコピー
